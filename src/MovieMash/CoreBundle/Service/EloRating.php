...
/**
 * This class calculates ratings based on the Elo system used in chess. This a fork to adapt it as a service
 *
...
namespace MovieMash\CoreBundle\Service;
...
class Rating
{
     ...
     */
    const KFACTOR = 16;     // permet de faire progresser le classement plus ou moins vite
     ...
     */
    public function result($ratingA,$ratingB,$scoreA,$scoreB)
    {
